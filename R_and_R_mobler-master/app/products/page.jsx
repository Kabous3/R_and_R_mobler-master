        ...
        <section>
            ...
            <div className="mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8">
                    ...
                    >
                        ...
                        <ul className="space-y-1 border-t border-gray-200 p-4">
                            ...
                            <label htmlFor="FilterRed" className="inline-flex items-center gap-2">
                                ...
                                <span className="h-6 w-6 rounded-full bg-red-600 ring-1 ring-gray-300"></span>
                            ...
                            <label htmlFor="FilterBlue" className="inline-flex items-center gap-2">
                                ...
                                <span className="h-6 w-6 rounded-full bg-blue-600 ring-1 ring-gray-300"></span>
                            ...
                            <label htmlFor="FilterGreen" className="inline-flex items-center gap-2">
                                ...
                                <span className="h-6 w-6 rounded-full bg-green-600 ring-1 ring-gray-300"></span>
                            ...
                            <label htmlFor="FilterOrange" className="inline-flex items-center gap-2">
                                ...
                                <span className="h-6 w-6 rounded-full bg-orange-600 ring-1 ring-gray-300"></span>
                            ...
                            <label htmlFor="FilterPurple" className="inline-flex items-center gap-2">
                                ...
                                <span className="h-6 w-6 rounded-full bg-purple-600 ring-1 ring-gray-300"></span>
                            ...
                            <label htmlFor="FilterTeal" className="inline-flex items-center gap-2">
                                ...
                                <span className="h-6 w-6 rounded-full bg-teal-600 ring-1 ring-gray-300"></span>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Link key={product.id} href={`/products/${getSlug(product.title)}`}>
                        <div className="block border border-gray-200 p-4 shadow-sm">
                        <img
                            src={product.image}
                            alt={product.title}
                        ...
                        <div className="mt-4">
                            ...
                            <p className="mt-2 text-lg font-medium text-gray-900">{product.price} kr</p>
                        </div>
                        </div>
                    </Link>
                    ))}
